...
class Test(unittest.TestCase):
    ...
    def test_example(self):
        ...
        driver.find_element(By.LINK_TEXT,"Rectruitment").click()
        ...
        while True:
            ...
            Recruitment_list = driver.find_elements(By.CLASS_NAME, "a.oxd-main-menu-item.active")

            count_on_page = len(Recruitment_list)
